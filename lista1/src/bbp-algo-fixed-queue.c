...
/**
  ...
  @file   bbp-algo-fixed-queue.c
  @author Flávio M.
  @brief  Implements BBP Algo Concurrently Using a Static Queue
          and Batches.
 */
/*-----------------------------------------------------------------*/
...
long double rhs(long double, int);
...
void enqueue(int arg1, long long arg2) {
